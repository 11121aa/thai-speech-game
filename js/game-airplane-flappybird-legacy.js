...
// ============================================================
//  [ARCHIVED] This is the original tap-to-flap Flappy Bird version of the
//  airplane game, kept for reference. It is NOT loaded by any page — the
//  live game is js/game-airplane.js, reworked into a hold-and-drag
//  Subway-Surfers-style jetpack flight game. To bring this version back,
//  copy this file's contents into js/game-airplane.js and bump the
//  cache-bust version on its <script> tag in game.html.
// ============================================================
